        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5">
                <nav aria-label="Page navigation">
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class=""><a href="showNews?page=1" aria-label="Previous"><span
                                    aria-hidden="true">首页</span></a></li>
                            <c:forEach begin="1" end="${news.pageCount}" step="1" var="index">
                                <li class="${news.page==index?'active':''}"><a
                                        href="showNews?page=${index}">${index}<span
                                        class="sr-only">(current)</span></a>
                                </li>
                            </c:forEach>
                            <li><a href="showNews?page=${news.pageCount}" aria-label="Next"><span
